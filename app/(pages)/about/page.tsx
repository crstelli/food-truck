  ...
  return (
    <div className="flex flex-col p-10">
      ...
      <main className="w-[90%] max-w-[1200px] items-center gap-x-20 mx-auto grid grid-cols-2 py-20">
        <H1 className="text-left text-5xl col-span-2 font-bold first-letter:text-primary">
          About
        </H1>
        <P className="text-lg">
        ...
        <div className="relative aspect-video justify-self-end w-[500px] overflow-hidden rounded-md border shadow-2xl">
        ...
        <P className="text-lg text-right">
          ...
          e veloce, senza perdere tempo a cercare strade o parcheggi. Sia che tu
